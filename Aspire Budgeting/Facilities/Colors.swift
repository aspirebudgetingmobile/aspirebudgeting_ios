...
extension Color {
  ...
  static let cinnamonSatin = Color("cinnamonSatin")
  static let camel = Color("camel")
  static let darkElectricBlue = Color("darkElectricBlue")
  static let keppel = Color("keppel")
  static let copperRed = Color("copperRed")
  static let forestGreenCrayola = Color("forestGreenCrayola")
  static let antiqueBrass = Color("antiqueBrass")
  static let darkCornflowerBlue = Color("darkCornflowerBlue")
  static let hookersGreen = Color("hookersGreen")
  static let middleBluePurple = Color("middleBluePurple")
  static let redwood = Color("redwood")
  static let cyclamen = Color("cyclamen")
  static let paoloVeroneseGreen = Color("paoloVeroneseGreen")
