...
//      getSpreadsheetsQuery: mockQuery
//    )
//
//    postNotification()
...
//
//    sinkCancellable = sheetsManager.$error.dropFirst().sink { error in
...
//
//    let mockQuery = GTLRSheetsQuery_SpreadsheetsValuesGet.query(
//      withSpreadsheetId: "42",
//      range: "range"
//    )
//
//    let sheetsService = GTLRSheetsService.mockService(
//      withFakedObject: mockValueRange,
//      fakedError: nil
//    )
//
//    let sheetsManager = GoogleSheetsManager(
